...
#define TEST_ITEM_INCELL                                                       \
	{                                                                      \
		"SHORT_CIRCUIT_TEST", "OPEN_TEST",	"CB_TEST",             \
		"RAWDATA_TEST",	      "LCD_NOISE_TEST", "KEY_SHORT_TEST",      \
		"MUX_OPEN_TEST",                                               \
	}
...
#define BASIC_THRESHOLD_INCELL                                                 \
	{                                                                      \
		"ShortCircuit_ResMin",                                         \
		"ShortCircuit_VkResMin",                                       \
		"OpenTest_CBMin",                                              \
		"OpenTest_Check_K1",                                           \
		"OpenTest_K1Threshold",                                        \
		"OpenTest_Check_K2",                                           \
		"OpenTest_K2Threshold",                                        \
		"CBTest_Min",                                                  \
		"CBTest_Max",                                                  \
		"CBTest_VKey_Check",                                           \
		"CBTest_Min_Vkey",                                             \
		...
		"RawDataTest_Min",                                             \
		"RawDataTest_Max",                                             \
		"RawDataTest_VKey_Check",                                      \
		"RawDataTest_Min_VKey",                                        \
		"RawDataTest_Max_VKey",                                        \
		"LCD_NoiseTest_Frame",                                         \
		"LCD_NoiseTest_Coefficient",                                   \
		"LCD_NoiseTest_Coefficient_key",                               \
		"OpenTest_DifferMin",                                          \
		"OpenTest_DifferMax",                                          \
	}
...
#define BASIC_THRESHOLD_MC_SC                                                  \
	{                                                                      \
		...
		"RawDataTest_HighFreq",                                        \
		"RawDataTest_Low_Min",                                         \
		"RawDataTest_Low_Max",                                         \
		"RawDataTest_LowFreq",                                         \
		"UniformityTest_Check_Tx",                                     \
		"UniformityTest_Check_Rx",                                     \
		"UniformityTest_Check_MinMax",                                 \
		"UniformityTest_Tx_Hole",                                      \
		"UniformityTest_Rx_Hole",                                      \
		"UniformityTest_MinMax_Hole",                                  \
		"SCapCbTest_OFF_Min",                                          \
		"SCapCbTest_OFF_Max",                                          \
		"ScapCBTest_SetWaterproof_OFF",                                \
		"SCapCbTest_ON_Min",                                           \
		"SCapCbTest_ON_Max",                                           \
		"ScapCBTest_SetWaterproof_ON",                                 \
		"SCapRawDataTest_OFF_Min",                                     \
		"SCapRawDataTest_OFF_Max",                                     \
		"SCapRawDataTest_SetWaterproof_OFF",                           \
		"SCapRawDataTest_ON_Min",                                      \
		"SCapRawDataTest_ON_Max",                                      \
		"SCapRawDataTest_SetWaterproof_ON",                            \
		"WeakShortTest_CG",                                            \
		"WeakShortTest_CC",                                            \
		"PanelDifferTest_Min",                                         \
		"PanelDifferTest_Max",                                         \
		...
		"SCapRawDataTest_High_Min",                                    \
		"SCapRawDataTest_High_Max",                                    \
		"SCapRawDataTest_SetHighSensitivity",                          \
		"SCapCbTest_Hov_Min",                                          \
		"SCapCbTest_Hov_Max",                                          \
		"ScapCBTest_SetHov",                                           \
		"SCapRawDataTest_Hov_Min",                                     \
		"SCapRawDataTest_Hov_Max",                                     \
		"SCapRawDataTest_SetHov",                                      \
		"NoiseTest_Max",                                               \
		"NoiseTest_Frames",                                            \
		"NoiseTest_FwNoiseMode",                                       \
		"Polling_Frequency",                                           \
	}
...
#define BASIC_THRESHOLD_SC                                                     \
	{                                                                      \
		...
		"CbTest_Max",                                                  \
		"DeltaCbTest_Base",                                            \
		"DeltaCbTest_Differ_Max",                                      \
		"DeltaCbTest_Include_Key_Test",                                \
		"DeltaCbTest_Key_Differ_Max",                                  \
		"DeltaCbTest_Deviation_S1",                                    \
		"DeltaCbTest_Deviation_S2",                                    \
		"DeltaCbTest_Deviation_S3",                                    \
		"DeltaCbTest_Deviation_S4",                                    \
		"DeltaCbTest_Deviation_S5",                                    \
		"DeltaCbTest_Deviation_S6",                                    \
		"DeltaCbTest_Set_Critical",                                    \
		"DeltaCbTest_Critical_S1",                                     \
		"DeltaCbTest_Critical_S2",                                     \
		"DeltaCbTest_Critical_S3",                                     \
		"DeltaCbTest_Critical_S4",                                     \
		"DeltaCbTest_Critical_S5",                                     \
		"DeltaCbTest_Critical_S6",                                     \
	}
